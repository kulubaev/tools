...
<!-- saved from url=(0070)https://raw.github.com/ryanb/dotfiles/master/vim/colors/railscasts.vim -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Vim color scheme based on http://github.com/jpo/vim-railscasts-theme
"
" Name:        railscasts.vim
